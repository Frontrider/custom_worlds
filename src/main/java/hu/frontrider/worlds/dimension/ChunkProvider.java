...
public class ChunkProvider implements IChunkGenerator{
    ...
    protected final IBlockState WATER;
    ...
    public ChunkProvider(World worldIn, DimensionHolder settings)
    {
        STONE = settings.material.getBlock();
        WATER = settings.fluid.getBlock();
        ChunkGeneratorSettings.Factory factory = new ChunkGeneratorSettings.Factory();
        factory.seaLevel = settings.sealevel;
